...
export default function Index({ setIsOn }) {
    ...
    return (
        <div className="mx-8 text-[#efe3d9] h-full flex justify-center flex-col font-normal w-4/6">
            ...
            <h3 className='p-4 lg:p-5 font-bold md:text-2xl max-w-fit mx-auto lg:text-2xl rounded-md bg-[#639e98] animate__animated animate__fadeInRight  animate__delay-1s'>
            ...
            <h3 className='p-4 my-2 lg:p-5 text-sm md:text-2xl max-w-fit mx-auto lg:text-2xl rounded-md bg-[#fc8b92] animate__animated animate__fadeInRight animate__delay-5s'>
