    ...
    return (
        <div className="h-screen grid place-items-center w-5/6 text-[#efe3d9]">
            <div>
                ...
                <h1 className="text-center shadow-md px-1 py-4 md:px-10 mx-auto lg:text-xl rounded-md animate__animated animate__fadeInDownBig animate__delay-2s text-3xl mt-5 bg-[#fc8b92]">الدوائر الكهربائية</h1>
            </div>
        </div>
    )
}
