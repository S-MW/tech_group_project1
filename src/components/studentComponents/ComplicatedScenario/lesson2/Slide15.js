    ...
    return (
        <>
            <div className="mx-5 text-[#efe3d9] h-full flex justify-center flex-col font-normal w-4/6">
                <h3 className='p-2 text-center my-3 lg:p-5 text-2xl max-w-fit mx-auto md:text-3xl rounded-md bg-[#fa976d] animate__animated animate__backInDown'>
                    علام يدل الرمز kwh؟ وماذا يقيس؟
                </h3>
                <h3 className='p-2 text-center lg:p-5 text-lg max-w-fit mx-auto md:text-xl rounded-md bg-[#fc8b92] animate__animated animate__backInDown animate__delay-4s'>
