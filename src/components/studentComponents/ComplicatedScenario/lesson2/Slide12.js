    ...
    return (
        <>
            <div className={`px-8 text-[#efe3d9] h-full font-normal flex gap-5 justify-center flex-col w-full`}>
                <div className='p-2 text-2xl mx-auto md:text-5xl shadow-md rounded-md animate__animated animate__backInDown bg-[#fa976d]'>
                    القدرة الكهربائية
                </div>
                <div className='p-2 text-xl sm:text-lg mx-auto md:text-4xl shadow-md lg:text-4xl rounded-md animate__animated animate__backInDown animate__delay-2s bg-[#edac34]'>
                    معدل تحول الطاقة الكهربائية الى اى شكل اخر من الطاقة.
                </div>
                <div className='p-2 text-lg sm:text-xl mx-auto md:text-3xl shadow-md rounded-md animate__animated animate__backInDown animate__delay-7s bg-[#639e98]'>
                ...
                <h3 className='md:w-1/2 p-2 text-center shadow-md mx-auto md:text-2xl rounded-md animate__animated animate__backInDown animate__delay-13s bg-[#fc8b92]'>
