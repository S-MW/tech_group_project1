    ...
    return (
        <>
            <div className={`px-8 text-[#efe3d9] h-full font-normal flex gap-5 justify-center flex-col w-full`}>
                ...
                <div className='md:w-1/2 lg:w-1/3 px-6 py-2 text-xl shadow-md md:text-2xl mx-auto lg:text-xl rounded-md animate__animated animate__backInDown animate__delay-7s bg-[#fc8b92]'>
