    ...
    return (
        <>
            <div className={`px-8 text-[#efe3d9] h-full font-normal flex gap-5 justify-center flex-col w-full`}>
                ...
                <div className='shadow-md px-10 py-4 text-2xl mx-auto lg:text-xl rounded-md bg-[#fa976d] animate__animated animate__backInDown'>
                    قياس القدرة الكهربائية
                </div>
                <div className='shadow-md px-6 py-2 text-xl mx-auto lg:text-xl rounded-md animate__animated animate__backInDown animate__delay-3s bg-[#edac34]'>
                    ما معنى أن مصباحا كهربائيا يستهلك قدرة كهربائية 100 واط؟
                </div>
                <div className='shadow-md px-6 py-2 text-xl mx-auto lg:text-xl rounded-md animate__animated animate__backInDown animate__delay-8s bg-[#fc8b92]'>
