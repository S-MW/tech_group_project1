...
export default function SL1s10(props) {
  ...
  return (
    <>
      <div className="grid grid-cols-1 text=xl sm:text-2xl font-bold w-2/3 my-3 justify-items-center
            md:text-lg
            lg:text-2xl">
        <div className="bg-[#639e98] animate__animated animate__zoomIn p-2 rounded-md my-1 w-fit
        md:text-lg md:my-2 md:p-5
        lg:text-2xl">
          <div className="grid grid-rows-2 grid-flow-col justify-items-center items-center">
            ...
            <div className='row-span-2'><img src="/slide10_0.jpg" alt="" className="animate__animated animate__bounceInDown w-60 ml-1 h-32" /></div>
          </div>
        </div>
        ...
        lg:text-2xl">
          <div className="grid grid-rows-2 grid-flow-col justify-items-center items-center">
            ...
            <div className='row-span-2'><img src="/slide10_1.jpg" alt="" className="animate__animated animate__bounceInDown w-60 ml-1 h-32" /></div>
          </div>
        </div>
        ...
        lg:text-2xl">
          <div className="grid grid-rows-2 grid-flow-col justify-items-center items-center">
            ...
            <div className='row-span-2'><img src="/slide10_2.jpg" alt="" className="animate__animated animate__bounceInDown w-60 ml-1 h-32" /></div>
          </div>
        </div>
